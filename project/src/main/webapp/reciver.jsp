...
<body>
 ...
 <div class="container mt-5">
        <h2 class="text-center mb-4">Accepted Request</h2>
...
<%
    ...
    String sname = "", number = "", address = "", blood = ""; // Declare variables
    if (name != null) {
...
<div class="d-flex justify-content-center">
                    <button type="submit" class="bg-dark p-2" style="border:none; border-radius:10px;"><a href="home.jsp" style="text-decoration: none;"
                            class="text-white">Back to Home</a> <i class="fa-solid fa-house text-white" style="margin-left:5px;"></i></button>
                </div>
